...
declare const ThemedLayout: React.FC<import("emotion-theming/types/helper").AddOptionalTo<Pick<LayoutProps & React.RefAttributes<Layout>, "ref" | "key"> & Partial<Pick<LayoutProps & React.RefAttributes<Layout>, "children" | "theme" | "viewMode" | "options" | "docsOnly" | "bounds" | "panelCount">> & Partial<Pick<Partial<LayoutProps>, never>>, "theme">>;
